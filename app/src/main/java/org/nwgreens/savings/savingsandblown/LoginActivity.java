...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mEmailView.setText("admin@gsb.com");
...
*/
        if (cancel) {
            ...
            builder.setMessage("Should work");
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            StringRequest request = new StringRequest(Request.Method.POST, String.format("%slogin",getApplicationContext().getResources().getText(R.string.url)),//://10.0.0.13/login",
                    ...
                    new Response.ErrorListener() {
                        ...
                        public void onErrorResponse(VolleyError error) {
                            mPasswordView.setError("Failed To Login");
                        }
                    }) {
                @Override
                protected Map<String, String> getParams() {
                    Map<String, String> returnValue = new HashMap<String, String>();
                    returnValue.put("username", mEmail);
                    returnValue.put("password", mPassword);
